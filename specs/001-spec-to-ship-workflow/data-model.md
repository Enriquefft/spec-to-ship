...
This document defines the data structures, entities, and relationships for the Spec-to-Ship CLI tool. All data is file-based (Markdown, Bash config, JSON logs).
...
- HITL_TIMEOUT must be empty or match pattern: `[0-9]+[smh]` (seconds/minutes/hours)
...
**File**: `docs/PRD_STRUCTURED.md`
**Format**: Markdown (templated)
...
**Format**: Markdown with embedded state markers
...
**File**: `docs/gates/M{n}-gate-report.md`
**Format**: Markdown
...
**File**: `.workflow/logs/{timestamp}.log`
