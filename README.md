...
Inspired by [spec-kit](https://github.com/github/spec-kit) and [ralph-claude-code](https://github.com/frankbria/ralph-claude-code).
...
Key settings:
- `PROVIDER_DEFAULT` - AI provider (claude, opencode, gemini)
